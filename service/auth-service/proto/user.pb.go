...
const file_proto_user_proto_rawDesc = "" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage2\x9f\x02\n" +
	"\vUserService\x125\n" +
	...
	"\n" +
	"UpdateUser\x12\x17.user.UpdateUserRequest\x1a\x12.user.UserResponse\x120\n" +
	"\n" +
	"DeleteUser\x12\f.user.UserID\x1a\x14.user.DeleteResponseB\x14Z\x12auth-service/protob\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	3, // 2: user.UserService.GetUserProfile:input_type -> user.UserID
	5, // 3: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	3, // 4: user.UserService.DeleteUser:input_type -> user.UserID
	6, // 5: user.UserService.RegisterUser:output_type -> user.UserResponse
	2, // 6: user.UserService.AuthenticateUser:output_type -> user.AuthResponse
	4, // 7: user.UserService.GetUserProfile:output_type -> user.UserProfile
	6, // 8: user.UserService.UpdateUser:output_type -> user.UserResponse
	7, // 9: user.UserService.DeleteUser:output_type -> user.DeleteResponse
